...
class SaeMail{
	 ...
	 * @param   [type]     $smtp_user [description]
	 * @param   [type]     $smtp_pass [description]
	 * @param   string     $smtp_host [description]
	 * @param   integer    $smtp_port [description]
	 * @param   boolean    $smtp_tls  [description]
